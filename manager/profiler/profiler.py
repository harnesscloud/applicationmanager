...
class Profiler:
	...
	def __init__(self, application, version, parameters = {}):
		...
		self.strategy = DirectedSimulatedAnnealing(self.execute_application, len(self.variables), VariableMapper.Interval[0], VariableMapper.Interval[1], self.confMapper)
		data = self.restore()
